                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="float-right mt-2"><a href="#" class="text-primary"><i
                                                        class="mdi mdi-arrow-right h5"></i></a></div>
                                            <h6 class="mb-0"><img src="{{asset('backend/assets/images/users/user-3.jpg')}}" alt=""
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div><img src="{{asset('backend/assets/images/users/user-2.jpg')}}" alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div><img src="{{asset('backend/assets/images/users/user-3.jpg')}}" alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div><img src="{{asset('backend/assets/images/users/user-4.jpg')}}" alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div><img src="{{asset('backend/assets/images/users/user-5.jpg')}}" alt=""
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div><img src="{{asset('backend/assets/images/users/user-6.jpg')}}" alt=""
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="chat-conversation">
                                        <ul class="conversation-list slimscroll" style="max-height: 400px;">
                                            <li class="clearfix">
                                                <div class="chat-avatar"><img src="{{asset('backend/assets/images/users/user-2.jpg')}}"
                                                        alt="male"> <span class="time">10:00</span></div>
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar"><img src="{{asset('backend/assets/images/users/user-3.jpg')}}"
                                                        alt="Female"> <span class="time">10:01</span></div>
                                                <div class="conversation-text">
                                            ...
                                            <li class="clearfix">
                                                <div class="chat-avatar"><img src="{{asset('backend/assets/images/users/user-2.jpg')}}"
                                                        alt="male"> <span class="time">10:04</span></div>
                                                <div class="conversation-text">
                                                    <div class="ctext-wrap"><span class="user-name">John Deo</span>
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar"><img src="{{asset('backend/assets/images/users/user-3.jpg')}}"
                                                        alt="male"> <span class="time">10:05</span></div>
                                                <div class="conversation-text">
                                                    <div class="ctext-wrap"><span class="user-name">Smith</span>
                                            ...
                                            <li class="clearfix odd">
                                                <div class="chat-avatar"><img src="{{asset('backend/assets/images/users/user-3.jpg')}}"
                                                        alt="male"> <span class="time">10:08</span></div>
                                                <div class="conversation-text">
                                                    <div class="ctext-wrap"><span class="user-name mb-2">Smith</span>
                                                        <img src="{{asset('backend/assets/images/small/img-1.jpg')}}" alt="" height="48px"
                                                            class="rounded mr-2"> <img
                                                            src="{{asset('backend/assets/images/small/img-2.jpg')}}" alt="" height="48px"
                                                            class="rounded"></div>
                                                </div>
                                            </li>
                                        </ul>
