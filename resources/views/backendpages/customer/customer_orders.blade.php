                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-dark mb-0">
                                            ...
                                            <tbody>
                                            @forelse ( App\Reservation::where('client_id',Auth::user()->id)->get() as $reservation)
                                                <tr>
                ...
                <!-- end row -->
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Cancelled Orders</h4>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-dark mb-0">
                                            <thead>
                                                <tr class="bg-warning">
                                            ...
                                            @forelse($deleted_reservations as $deleted_reservation)
                                                <tr>
                                                    ...
                                                    <td class="text-info">{{ $deleted_reservation->status }}</td>
                                                    <td> 
